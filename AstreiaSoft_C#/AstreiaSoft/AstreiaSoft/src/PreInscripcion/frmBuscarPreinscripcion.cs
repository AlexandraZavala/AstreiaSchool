    ...
    public partial class frmBuscarPreinscripcion : Form
    {
        ...
        private void cargarHijos()
        {
            try
            {
                ...
                AdminWS.usuario[] hijosSourceSet = client.listarHijosDePadre(GlobalVariables.IdUsuario);
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int idPadre = GlobalVariables.IdUsuario; // Aquí debes obtener el ID del padre de familia.
                ...
                if (PreinscripcionesDisponibles != null)
                {
                    foreach (inscripcion inscripcion in PreinscripcionesDisponibles)
                    {
                        ...
                        dgvPreInscripciones.Rows.Add(inscripcion.idInscripcion, nombreCompleto, inscripcion.periodoAcademico, inscripcion.fecha, inscripcion.estado, inscripcion.esNuevo ? "Nuevo" : "Recurrente");
                    }
                }
                else
                {
