            ...
            try
            {
                ...
                if (PreinscripcionesDisponibles != null)
                {
                    foreach (inscripcion inscripcion in PreinscripcionesDisponibles)
                    {
                        ...
                        dgvRevisionPreinscripciones.Rows.Add(inscripcion.idInscripcion, inscripcion.estudiante.nombre, inscripcion.periodoAcademico, inscripcion.fecha, inscripcion.estado, inscripcion.esNuevo ? "Nuevo" : "Recurrente");
                    }
                }
                else
                {
