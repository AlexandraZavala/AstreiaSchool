...
public class MallaWS {
    ...
    @WebMethod(operationName = "verificarEliminarArea")
    public int verificarEliminarArea(@WebParam(name = "idArea") int idArea) {
        int resultado = 0;
        try {
            resultado = daoAreaCurricular.verificar_eliminar_area(idArea);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    @WebMethod(operationName = "eliminarHorariosCursoPro")
    public int eliminarHorariosCursoPro(@WebParam(name = "idCursoProgramado") int idCursoProgramado) {
        int resultado = 0;
        try {
            resultado = daoCursoProgramado.eliminarHorarios(idCursoProgramado);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    @WebMethod(operationName = "verificarCursoProgramadoDocente")
    public int verificarCursoProgramadoDocente(@WebParam(name = "idCurso") int idCursoPro,
            @WebParam(name = "idDocente") int idDocente) {
        int resultado = 0;
        try {
            resultado = daoCursoProgramado.verificar_docente(idCursoPro,idDocente);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    @WebMethod(operationName = "asignarDocenteCursoProgramado")
    public int asignarDocenteCursoProgramado(@WebParam(name = "idCursoPro") int idCursoPro,
           @WebParam(name = "idDocente") int idDocente ) {
        int resultado = 0;
        try {
            resultado = daoCursoProgramado.asignarDocenteCursoProgramado(idCursoPro,idDocente);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    @WebMethod(operationName = "verificarEliminarCurso")
    public int verificarEliminarCurso(@WebParam(name = "idCurso") int idCurso) {
        int resultado = 0;
        try {
            resultado = daoCurso.verificar_eliminar_curso(idCurso);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    public ArrayList<Horario> listarHorarioPorSeccion(@WebParam(name = "idSeccion") int idSeccion){
    ...
    public ArrayList<Horario> listarHorarioPorIdDocente(@WebParam(name = "idDocente") int idDocente){
        ArrayList<Horario> horarios = new ArrayList<>();
        try{
    ...
    @WebMethod(operationName = "eliminarHorarioCursDocente")
    public int verificarEliminarHorarioCursDocente(@WebParam(name = "idHorario") int idHorario) {
        int resultado = 0;
        try {
            resultado = daoHorario.verificarEliminarHorarioCursDocente(idHorario);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    @WebMethod(operationName = "eliminarHorarioCursEstudiante")
    public int verificarEliminarHorarioCursEstudiante(@WebParam(name = "idHorario") int idHorario) {
        int resultado = 0;
        try {
            resultado = daoHorario.verificarEliminarHorarioCursEstudiante(idHorario);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
