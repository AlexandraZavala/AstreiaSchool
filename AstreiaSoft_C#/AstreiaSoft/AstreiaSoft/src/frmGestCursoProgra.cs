...
namespace WindowsFormsApp1
{
    public partial class frmGestCursoProgra : Form
    {
        ...
        public frmGestCursoProgra()
        {
            ...
            cboCurso.DisplayMember = "nombreGrado";
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (_cursoProSeleccionado != null)
            {
                ...
                DialogResult resultado = MessageBox.Show("Se eliminaran los horarios asociados. ¿Estás seguro de que deseas eliminar este Curso?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                if (resultado == DialogResult.Yes)
                {
                    int resultadoEliminacion = _daoServicioWeb.eliminarHorariosCursoPro(_cursoProSeleccionado.idCursoProgramado);
                    resultadoEliminacion = _daoServicioWeb.eliminarCursoProgramado(_cursoProSeleccionado.idCursoProgramado);
        ...
        private void dgvCursoPro_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (cursoProgramado != null)
            {
                ...
                dgvCursoPro.Rows[e.RowIndex].Cells[0].Value = cursoProgramado.nombreCursoGrado;
