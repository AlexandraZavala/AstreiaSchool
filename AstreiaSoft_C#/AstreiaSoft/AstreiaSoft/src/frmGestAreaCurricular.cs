...
namespace WindowsFormsApp1
{
    public partial class frmGestAreaCurricular : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (_daoServicioWeb.verificarEliminarArea(_areaSeleccionada.idAreaCurricular)>0)
                {
                    MessageBox.Show("El área curricular seleccionada tiene cursos generales asociados.", "Mensaje de Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
