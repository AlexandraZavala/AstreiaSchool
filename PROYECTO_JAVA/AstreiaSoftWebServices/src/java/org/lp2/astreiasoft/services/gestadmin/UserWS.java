...
public class UserWS {
    ...
    //nuevo de Ale
    @WebMethod(operationName = "obtenerSeccion")
    public int obtenerSeccion(@WebParam(name = "idUsuario")int idUsuario) {
        int resultado = 0;
        try{
            resultado = daoEstudiante.obtenerSeccion(idUsuario);
        }catch(Exception ex){
            System.out.println(ex.getMessage());
        }
        return resultado;
    ...
    //nuevo Alberto
    @WebMethod(operationName = "obtenerNombreDocente")
    public String obtenerNombreDocente(@WebParam(name = "idDocente")int idDocente) {
        String nombreCompleto = "";
        try{
            nombreCompleto = daoDocente.obtenerNombre(idDocente);
        }catch(Exception ex){
            System.out.println(ex.getMessage());
        }
	...
	//nuevo lucia
    //NUEVO
    @WebMethod(operationName = "obtenerNombreGradoSeccion")
    public String obtenerNombre_Grado_Seccion(@WebParam(name = "idGrado") int idGrado,
                                    @WebParam(name = "idSeccion") int idSeccion) {
        String resultado =null;
        try {
            resultado = daoEstudiante.obtenerNombre_Grado_Seccion(idGrado, idSeccion);
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
        return resultado;
